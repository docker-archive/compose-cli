...
func execCommand(p *projectOptions, w WithComposeService) *cobra.Command {
	opts := execOpts{
...
func runExec(ctx context.Context, s compose.Service, opts execOpts) error {
	...
	return s.Exec(ctx, project, execOpts)
}
