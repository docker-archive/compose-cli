...
import (
	...
	contextcmd "github.com/docker/compose-cli/v2/cli/cmd/context"
	"github.com/docker/compose-cli/v2/cli/cmd/login"
	"github.com/docker/compose-cli/v2/cli/cmd/logout"
	"github.com/docker/compose-cli/v2/cli/cmd/run"
	"github.com/docker/compose-cli/v2/cli/cmd/volume"
	...
	cliopts "github.com/docker/compose-cli/v2/cli/options"
	compose2 "github.com/docker/compose-cli/v2/cmd/compose"
	"github.com/docker/compose-cli/v2/local"
	"github.com/docker/compose-cli/v2/pkg/api"
	"github.com/docker/compose-cli/v2/pkg/compose"

	// Backend registrations
	_ "github.com/docker/compose-cli/v2/aci"
	_ "github.com/docker/compose-cli/v2/ecs"
	_ "github.com/docker/compose-cli/v2/ecs/local"
	_ "github.com/docker/compose-cli/v2/local"
)
